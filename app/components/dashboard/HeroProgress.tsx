...
export default function HeroProgress() {
  ...
  const completionPercent = totalStickers === 0 ? 0 : Math.round((collectedUnique / totalStickers) * 100);
    ...
    <section className="glass-card rounded-xl p-8 mb-8 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="flex-1">
          <h2 className="font-display-lg text-display-lg text-on-surface mb-2">{completionPercent}% Complete</h2>
